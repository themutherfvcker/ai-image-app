      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            ...
            <a href="https://nano-banana-16-9-image-creator.vercel.app/" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-yellow-500">16:9 Image Generator</a>
        ...
        <div className="sm:hidden">
          ...
          <div ref={panelRef} role="dialog" aria-modal="true" className="fixed inset-y-0 left-0 w-80 max-w-[85%] bg-white shadow-xl safe-area flex flex-col">
            ...
            <nav className="p-4 space-y-1">
              ...
              <a onClick={() => setOpen(false)} href="https://nano-banana-16-9-image-creator.vercel.app/" className="block px-3 py-3 rounded-md text-base font-medium text-gray-800 hover:bg-gray-50">16:9 Image Generator</a>
